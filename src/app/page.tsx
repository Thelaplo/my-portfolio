...
export default function Portfolio() {
  ...
  const projects = [
    ...
    },
    {
      ...
      images: ["/images/sitejaponcap.png","/images/BloomSpiritCarte.png", "/images/BloomSpiritDetail.png", "/images/BloomSpiritAdmin.png","/images/trelo.png"]
    },
    // {
    //   id: 3,
          ...
          >
            ...
            <div className="md:col-span-2 space-y-6">
              ...
              <div className="flex flex-wrap gap-4 pt-2">
                ...
                <a href="/images/public/images/cvLaplaceThéoENSITECH.pdf" target="_blank" className="flex items-center gap-2 bg-zinc-900 hover:bg-zinc-800 border border-zinc-700 px-6 py-3 rounded-xl text-xs font-bold transition-all uppercase italic">
